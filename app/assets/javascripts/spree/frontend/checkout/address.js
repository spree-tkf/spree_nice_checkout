    ...
    if ($('#checkout_form_address').length) {
      Spree.updateState = function (region) {
        ...
        Spree.toggleContainerWidth = function (data, region) {
          ...
          if (zipcodeRequired && statesRequired) {
            feildsContainer.removeClass('address-third address-half')
            feildsContainer.addClass('address-third')
          }  else if (zipcodeRequired || statesRequired) {
            feildsContainer.removeClass('address-third address-half')
            feildsContainer.addClass('address-half')
          } else {
            feildsContainer.removeClass('address-third address-half')
            feildsContainer.addClass('address-full')
          }
        }

        // Sets the Zipcode input required and visibility.
        ...
        // Fills in States and handels visability and required
